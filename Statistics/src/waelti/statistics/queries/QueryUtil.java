...
public class QueryUtil {
	 ...
	 * @return a new list.
	 */
	public static List<Object[]> createCohorts(List<Object[]> list,
			int intervall) {
	...
	public static List<Object[]> addAverage(List<Object[]> list, int InColumn1,
			int InColumn2, int resultColumn) {
		for (Object[] objects : list) {
