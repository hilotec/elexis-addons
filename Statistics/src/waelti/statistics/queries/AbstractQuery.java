...
public abstract class AbstractQuery extends BackgroundJob {
	 ...
	 * Used as a header before the result table.
	 */
	public String getHeader() {
		String header = "Auswertungsname: ";
		header += this.getTitle() + "\n";
		header += "Auswertungsdatum: "
				+ QueryUtil.convertFromCalendar(Calendar.getInstance());

		return header;
	}

	/**
	 * getName() used by BackgroundJob. Returns the name of this query. Used by
	 * the metamodel.
	 */
	...
	/**
	 * Returns a content provider containing the model which is represented by
	 * this query.
	 */
