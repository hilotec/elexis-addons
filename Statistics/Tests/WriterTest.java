...
public class WriterTest {
	...
	public void setUp() {
		...
		list.add(new Object[] { "1,1", "1,2", "1,3" });
		list.add(new Object[] { "2,1", "2,2", "2,3" });
		list.add(new Object[] { "3,1", "3,2", "3,3" });
		list.add(new Object[] { "4,1", "4,2", "4,3" });
		list.add(new Object[] { "5,1", "5,2", "5,3" });
