...
public class ResultMatrixTest {
	...
	public void setUp() {
		...
		list.add(new Object[] { "Name1", new Money(100), new Money(10),
				new Integer(12) });
		list.add(new Object[] { "Name2", new Money(200), new Money(20),
				new Integer(25) });
		list.add(new Object[] { "Name3", new Money(300), new Money(30),
				new Integer(36) });
		list.add(new Object[] { "Name4", new Money(400), new Money(40),
				new Integer(48) });
	...
	public void testAddRowObjectArray() {
		Object[] newRow = new Object[] { "Name5", new Money(500),
				new Money(50), new Integer(59) };
