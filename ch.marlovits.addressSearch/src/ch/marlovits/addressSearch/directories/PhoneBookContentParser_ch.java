...
public class PhoneBookContentParser_ch extends PhoneBookContentParser {
	...
	public String getSearchInfo(){
		...
		searchInfoText =
			searchInfoText.replaceAll("<span class=\"totalResults noPrint\">[^<]+</span>", ""); //$NON-NLS-1$
	 ...
	 * 
	 * @return the List of KontaktEntry's<br>
	 * <br>
	 * 
	 */
	 ...
	 * Abstract function, must override
	 * 
	 * @return the Kontakt in a HashMap, the possible keys of the HashMap are described above<br>
	 * <br>
	 * 
	 * @example: <div id="te_ojUHu3vXsUWJbXidz2_sRQ" onmouseover="lcl.search.onEntryHover(this)"
	 ...
	 *           alt="Dieser Eintrag kann auf der Karte angezeigt werden" height="26" width="27" />
	 *           </a> </div> <div class="entrybox"> <h4>
	 ...
	 * <br>
	 * 
	 * @example: <div class="resrowclr_yellow"> </br> <img class="imgbox"
	...
	public HashMap<String, String> extractMaxInfo(HashMap<String, String> kontaktHashMap){
		...
		boolean isCompany =
			(vCardParser.getVCardValue("X-ABShowAs", 0).equalsIgnoreCase("COMPANY"));
	...
	/*
	 * <li class="WLSep"><ul><li>Ortschaften, Gemeinden, Quartiere</li></ul></li> <li
	 * class="WLRow"><a href="javascript:void(0)"
	 * onClick="javascript:whereLiveSearch.update('Bülach')">Bülach</a></li> <li class="WLRow"><a
	 * href="javascript:void(0)"
	 * onClick="javascript:whereLiveSearch.update('Eschenmosen (Bülach)')">Eschenmosen
	 * (Bülach)</a></li> <li class="WLRow"><a href="javascript:void(0)"
	 * onClick="javascript:whereLiveSearch.update('Nussbaumen (Bülach)')">Nussbaumen
	 * (Bülach)</a></li> <li class="WLSep"><ul><li>Kantone, Bezirke, Regionen</li></ul></li> <li
	 * class="WLRow"><a href="javascript:void(0)"
	 * onClick="javascript:whereLiveSearch.update('Bülach (Bezirk/Amt)')">Bülach
	 * (Bezirk/Amt)</a></li>
	 */
	public String[][] getCitySuggestions(String part){
		...
		urlText = MessageFormat.format(urlText, new Object[] {
