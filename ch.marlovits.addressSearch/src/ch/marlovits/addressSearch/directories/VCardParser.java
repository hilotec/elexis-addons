...
public class VCardParser {
	...
	/**
	 * the constructor: save full contents and parse contents into the internal HashMap be careful:
	 * there may be more than just one entry for a single key! -> combine into one single entry,
	 * separate entries by ITEMSEPARATOR
	 * 
	 * @param vCardContents
	 */
	 ...
	 * 
	 * @param key
	 *            the key for which to find the matching value
	 * @param index
