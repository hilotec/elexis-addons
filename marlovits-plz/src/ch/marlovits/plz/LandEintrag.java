...
public class LandEintrag extends PersistentObject {
	...
	static {
		...
		addMapping(TABLENAME, "Landname=landname", "Landiso2=landiso2", "Landiso3=landiso3",
			"Landisonum=landisonum", "Landtld=landtld", "Landioc=landioc",
			"Landiso3166_2=landiso3166_2", "Landwikilink=landwikilink",
			"Landlanguage=landlanguage", "Landsorting=landsorting", "Plzregex=plzregex",
			"Plzregexmessage=plzregexmessage", "Strasseerlaubt=strasseerlaubt",
			"Kantonauswaehlen=kantonauswaehlen", "Deleted=deleted", "lastupdate=lastupdate");
	...
	public LandEintrag(String landname, String landiso2, String landiso3, String landisonum,
		String landtld, String landioc, String landiso3166_2, String landwikilink,
		String landlanguage){
		create(null);
		set(new String[] {
			"Landname", "Landiso2", "Landiso3", "Landisonum", "Landtld", "Landioc",
			"Landiso3166_2", "Landwikilink", "Landlanguage"
		}, new String[] {
			landname, landiso2, landiso3, landisonum, landtld, landioc, landiso3166_2,
			landwikilink, landlanguage
		});
	}
	
	public String toString(){
		/*
		 * return getName() + ", " + getZusatz() + ", " + getAdresse() + ", " //$NON-NLS-1$
		 * //$NON-NLS-2$ //$NON-NLS-3$ + getPlz() + " " + getOrt() + " " + getTelefon();
		 * //$NON-NLS-1$ //$NON-NLS-2$
		 */
