...
@XmlSeeAlso({
    ...
    ch.docbox.ws.cdachservices.ObjectFactory.class
})
public interface CDACHServices {
     ...
     * @param code
     * @return
     *     returns java.util.List<ch.docbox.ws.cdachservices.DocumentInfoType>
     */
    ...
    public void getClinicalDocument(
        ...
        Holder<ClinicalDocumentType> document,
        @WebParam(name = "attachment", targetNamespace = "", mode = WebParam.Mode.OUT)
        Holder<byte[]> attachment);

    /**
     * 
     * @return
     *     returns java.util.List<ch.docbox.ws.cdachservices.AppointmentType>
     */
     ...
     * @param type
     * @return
     *     returns java.util.List<org.hl7.v3.POCDMT000040IntendedRecipient>
     */
