package at.medevit.elexis.properties.propertyPage;
...
public class PatientPropertyPage extends PropertyPage implements
	...
	protected Control createContents(Composite parent) {
		...
		lblNachname.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));

		lblNachname.setText("Nachname");

		textVorname = new Text(comp, SWT.BORDER);
		textVorname.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));

		Label lblVorname = new Label(comp, SWT.NONE);
		lblVorname.setLayoutData(new GridData(SWT.RIGHT, SWT.BOTTOM, false,
				false, 1, 1));
		lblVorname.setText("Vorname");

		textNachname = new Text(comp, SWT.BORDER);
		textNachname.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));
		...
		comboGeschlecht.setItems(new String[] { SEX_MALE, SEX_FEMALE });
		...
		geburtsdatum = new CDateTime(comp, CDT.BORDER | CDT.DROP_DOWN
				| CDT.DATE_MEDIUM | CDT.TEXT_TRAIL);
		geburtsdatum.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1));
		new Label(comp, SWT.NONE);
		new Label(comp, SWT.NONE);

		Label lblTelefon1 = new Label(comp, SWT.NONE);
		lblTelefon1.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		lblTelefon1.setText("Telefon");

		textTelefon1 = new Text(comp, SWT.BORDER);
		textTelefon1.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));

		Label lblTelefon2 = new Label(comp, SWT.NONE);
		lblTelefon2.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		lblTelefon2.setText("Telefon");

		textTelefon2 = new Text(comp, SWT.BORDER);
		textTelefon2.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1));

		Label lblHandy = new Label(comp, SWT.NONE);
		lblHandy.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		lblHandy.setText("Handy");

		textHandy = new Text(comp, SWT.BORDER);
		textHandy.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false,
				1, 1));
		...
		textFax.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false,
				1, 1));
		new Label(comp, SWT.NONE);
		new Label(comp, SWT.NONE);
		...
		lblBemerkungen.setLayoutData(new GridData(SWT.RIGHT, SWT.TOP, false,
				false, 1, 1));
		lblBemerkungen.setText("Bemerkungen");

		textBemerkungen = new Text(comp, SWT.BORDER | SWT.MULTI);
		textBemerkungen.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
				true, 1, 1));
	...
	private Date getGeburtsdatum() {
		...
		try {
			...
			Status status = new Status(IStatus.WARNING,
					"at.medevit.elexis.properties", e.getLocalizedMessage());
	...
	protected void performApply() {
		...
		if (geschlechtSelection != -1) {
			if (comboGeschlecht.getItems()[geschlechtSelection].trim()
					.equalsIgnoreCase(SEX_MALE)) {
				geschlecht = "m";
			} else {
				geschlecht = "w";
			}
		...
		String bdS = cal.get(Calendar.DAY_OF_MONTH) + "."
				+ (cal.get(Calendar.MONTH) + 1) + "." + cal.get(Calendar.YEAR);
		String[] fields = { Patient.FLD_FIRSTNAME, Patient.FLD_NAME,
				Patient.FLD_DOB, Patient.FLD_E_MAIL, Patient.FLD_PHONE1,
				Patient.FLD_PHONE2, Patient.FLD_MOBILEPHONE,
				Patient.FLD_REMARK, Patient.FLD_FAX };
		String[] values = { textNachname.getText(), textVorname.getText(), bdS,
				textEmail.getText(), textTelefon1.getText(),
				textTelefon2.getText(), textHandy.getText(),
