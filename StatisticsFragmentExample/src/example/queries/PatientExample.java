...
public class PatientExample extends AbstractTimeSeries {

	private List<String> headings;

	/** Loader which loads all patients from the database */
	private final AbstractDataLoaderJob loader = (AbstractDataLoaderJob) JobPool.getJobPool()
	...
	public PatientExample() {
		super("Costs per patient");
		this.initHeading();
	}

	private void initHeading() {
		this.headings = new ArrayList<String>();
		this.headings.add("Patient's Name");
		this.headings.add("Total Costs");
	}
	...
	public String getDescription() {
		return "I am an example of a fragment.";
	}
	...
	public String getTitle() {
		return "Example Fragment: Costs per Patient";
	}
	...
	public String getHeader() {
		...
		str += "\nAuswertungszeitraum: "
			+ QueryUtil.convertFromCalendar(this.getStartDate());
