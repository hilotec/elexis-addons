...
public class CobasMiraConnection extends AbstractConnection {
	 ...
	 * @param l
	 */
	public CobasMiraConnection(String portName, String port, String settings, ComPortListener l){
		super(portName, port, settings, l);
	}
	
	/*
	 * Only Data in between a STXLF and ETXLF is captured and forwarded to the Listeners see
	 * sampledata/cobaslogsingle.txt for information about the message structure
	 * 
	 * @see ch.elexis.rs232.AbstractConnection#serialEvent(int, java.io.InputStream,
	 * gnu.io.SerialPortEvent)
	 */
	@Override
	public void serialEvent(int state, InputStream inputStream, SerialPortEvent e)
		throws IOException{
