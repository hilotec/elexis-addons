 ...
 * 
 *         This page is shown within Elexis / Preferences / Devices / Cobas Mira. It reads the
 *         current values, and stores the new values after modification.
 * 
 *         It is connected to the main Elexis program via plugin.xml / Extension Point
...
public class Preferences extends PreferencePage implements IWorkbenchPreferencePage {
	...
	protected Control createContents(final Composite parent){
		...
		String labIdentificationStr =
			Hub.localCfg.get(LABIDENTIFICATION, Messages
				.getString("CobasMiraAction.OwnLabIdentification"));
		...
		String ignoreUserStr =
			Hub.localCfg.get(IGNOREUSER, Messages.getString("CobasMiraAction.DefaultIgnoreUser")); //$NON-NLS-1$
		...
		ports.setText(Hub.localCfg.get(PORT, Messages.getString("CobasMiraAction.DefaultPort"))); //$NON-NLS-1$	
		...
		String timeoutStr =
			Hub.localCfg.get(TIMEOUT, Messages.getString("CobasMiraAction.DefaultTimeout")); //$NON-NLS-1$
