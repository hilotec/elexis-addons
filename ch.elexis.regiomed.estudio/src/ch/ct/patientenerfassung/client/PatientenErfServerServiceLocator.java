...
public class PatientenErfServerServiceLocator extends Service implements PatientenErfServerService {
	...
	public PatientenErfServer getPatientenErfassung() throws ServiceException{
		URL endpoint;
		try {
	...
	public PatientenErfServer getPatientenErfassung(URL portAddress) throws ServiceException{
		PatientenErfServer patientenerfserver;
		try {
			PatientenErfassungSoapBindingStub _stub =
				new PatientenErfassungSoapBindingStub(portAddress, this);
	...
	public Remote getPort(Class serviceEndpointInterface) throws ServiceException{
		try {
			if ((ch.ct.patientenerfassung.client.PatientenErfServer.class)
				.isAssignableFrom(serviceEndpointInterface)) {
				PatientenErfassungSoapBindingStub _stub =
					new PatientenErfassungSoapBindingStub(new URL(
						"https://estudio.clustertec.ch/axis/services/PatientenErfassung"), this);
				_stub.setPortName(getPatientenErfassungWSDDServiceName());
				PatientenErfassungSoapBindingStub patientenerfassungsoapbindingstub = _stub;
				return patientenerfassungsoapbindingstub;
			}
		...
		throw new ServiceException("There is no stub implementation for the interface:  "
			.concat(String.valueOf(String
				.valueOf(serviceEndpointInterface != null ? ((Object) (serviceEndpointInterface
					.getName())) : "null"))));
	}
	...
	public QName getServiceName(){
		return new QName("https://estudio.clustertec.ch/axis/services/PatientenErfassung",
			"PatientenErfServerService");
	}
	...
	private final String PatientenErfassung_address =
