...
public class PatientenErfClient {
	...
	public void speichernPatient() throws Exception{
		JDialog statusDialog = null;
		String cacerts =
			PlatformHelper.getBasePath(RegiomedAction.ROSENSTUDIO_ID) + File.separator + "cacerts";
		try {
			// patientenErfassungProp.load(new FileInputStream("patientenerfassung.properties"));
			log.debug("Sprache:".concat(String.valueOf(String.valueOf(patientenErfassungProp
				.getProperty("sprache", "de")))));
			Locale currentLocale =
				new Locale(patientenErfassungProp.getProperty("sprache", "de"), "CH");
			langResource = ResourceBundle.getBundle("LangResources", currentLocale);
			log.debug("Patientenfile:".concat(String.valueOf(String.valueOf(patientenErfassungProp
				.getProperty("patientenfile")))));
			log.debug("jndiName:".concat(String.valueOf(String.valueOf(patientenErfassungProp
			...
			PatientenErfServerServiceLocator serviceLocator =
				new PatientenErfServerServiceLocator();
			log.debug("Webservice address:".concat(String.valueOf(String.valueOf(serviceLocator
				.getPatientenErfassungAddress()))));
			log.debug("WSDD Service name:".concat(String.valueOf(String.valueOf(serviceLocator
			...
			JLabel jLabel =
				new JLabel((String) langResource.getObject("PatientendatenWerdenGelesen"));
			...
			log.debug("PatientNr:".concat(String.valueOf(String.valueOf(prop
				.getProperty("PatientNr")))));
			patient.setGebDat(prop.getProperty("Geburt"));
			log.debug("GeburtsDatum:".concat(String.valueOf(String.valueOf(prop
				.getProperty("Geburt")))));
			patient.setGeschlecht((short) 1);
			if (prop.getProperty("Sex") != null && prop.getProperty("Sex").equals("M"))
				patient.setGeschlecht((short) 1);
			if (prop.getProperty("Sex") != null
				&& (prop.getProperty("Sex").equals("F") || prop.getProperty("Sex").equals("W")))
				patient.setGeschlecht((short) 2);
			log
				.debug("Geschlecht:"
					.concat(String.valueOf(String.valueOf(prop.getProperty("Sex")))));
			...
			log.debug("Vorname:"
				.concat(String.valueOf(String.valueOf(prop.getProperty("Vorname")))));
			patient.setStrassenr(prop.getProperty("Strasse"));
			log.debug("Strasse:"
				.concat(String.valueOf(String.valueOf(prop.getProperty("Strasse")))));
			...
			log.debug("TelefonP:".concat(String.valueOf(String
				.valueOf(prop.getProperty("TelefonP")))));
			patient.setTelefonGeschaeft(prop.getProperty("TelefonG"));
			log.debug("TelefonG:".concat(String.valueOf(String
				.valueOf(prop.getProperty("TelefonG")))));
			if (prop.getProperty("Telefax") != null)
				patient.setTelefax(prop.getProperty("Telefax"));
			log.debug("Telefax:"
				.concat(String.valueOf(String.valueOf(prop.getProperty("Telefax")))));
			...
			log.debug("KVMitgliedNr:".concat(String.valueOf(String.valueOf(prop
				.getProperty("KVMitgliedNr")))));
			patient.setUVNummer(prop.getProperty("UVMitgliedNr"));
			log.debug("UVMitgliedNr:".concat(String.valueOf(String.valueOf(prop
				.getProperty("UVMitgliedNr")))));
			...
			JLabel jLabel1 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Arztnr"))))).append(": ").append(
					prop.getProperty("ArztNr")))));
			jLabel1.setForeground(Color.black);
			gbC.gridy = 1;
			g.setConstraints(jLabel1, gbC);
			JLabel jLabel2 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("PatientNr"))))).append(": ").append(
					prop.getProperty("PatientNr")))));
			jLabel2.setForeground(Color.black);
			gbC.gridy = 2;
			g.setConstraints(jLabel2, gbC);
			JLabel jLabel3 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Anrede"))))).append(": ").append(
					prop.getProperty("Anrede")))));
			jLabel3.setForeground(Color.black);
			gbC.gridy = 3;
			g.setConstraints(jLabel3, gbC);
			JLabel jLabel4 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Name"))))).append(": ").append(
			...
			JLabel jLabel5 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Vorname"))))).append(": ").append(
					prop.getProperty("Vorname")))));
			jLabel5.setForeground(Color.black);
			gbC.gridy = 5;
			g.setConstraints(jLabel5, gbC);
			JLabel jLabel6 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Geburtsdatum"))))).append(": ").append(
					prop.getProperty("Geburt")))));
			jLabel6.setForeground(Color.black);
			gbC.gridy = 6;
			g.setConstraints(jLabel6, gbC);
			JLabel jLabel7 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Geschlecht"))))).append(": ").append(
					prop.getProperty("Sex")))));
			jLabel7.setForeground(Color.black);
			gbC.gridy = 7;
			g.setConstraints(jLabel7, gbC);
			JLabel jLabel8 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("PLZ"))))).append(": ").append(
					prop.getProperty("PLZ")))));
			jLabel8.setForeground(Color.black);
			gbC.gridy = 8;
			g.setConstraints(jLabel8, gbC);
			JLabel jLabel9 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Ort"))))).append(": ").append(
			...
			JLabel jLabel10 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Kanton"))))).append(": ").append(
					prop.getProperty("Kanton")))));
			jLabel10.setForeground(Color.black);
			gbC.gridy = 10;
			g.setConstraints(jLabel10, gbC);
			JLabel jLabel11 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("Strasse"))))).append(": ").append(
					prop.getProperty("Strasse")))));
			jLabel11.setForeground(Color.black);
			gbC.gridy = 11;
			g.setConstraints(jLabel11, gbC);
			JLabel jLabel12 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("TelefonP"))))).append(": ").append(
					prop.getProperty("TelefonP")))));
			jLabel12.setForeground(Color.black);
			gbC.gridy = 12;
			g.setConstraints(jLabel12, gbC);
			JLabel jLabel13 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("TelefonG"))))).append(": ").append(
					prop.getProperty("TelefonG")))));
			jLabel13.setForeground(Color.black);
			gbC.gridy = 13;
			g.setConstraints(jLabel13, gbC);
			JLabel jLabel14 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("KVMitgliedNr"))))).append(": ").append(
					prop.getProperty("KVMitgliedNr")))));
			jLabel14.setForeground(Color.black);
			gbC.gridy = 14;
			g.setConstraints(jLabel14, gbC);
			JLabel jLabel15 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("UVMitgliedNr"))))).append(": ").append(
					prop.getProperty("UVMitgliedNr")))));
			jLabel15.setForeground(Color.black);
			gbC.gridy = 15;
			g.setConstraints(jLabel15, gbC);
			JLabel jLabel16 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("KVEAN-Nr"))))).append(": ").append(
					prop.getProperty("KVEanNr")))));
			jLabel16.setForeground(Color.black);
			gbC.gridy = 16;
			g.setConstraints(jLabel16, gbC);
			JLabel jLabel17 =
				new JLabel(String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
					.valueOf(langResource.getObject("UVEAN-Nr"))))).append(": ").append(
					prop.getProperty("UVEanNr")))));
			...
			statusDialog.show();
			int result =
				stub.speichernPatient(patient, patientenErfassungProp.getProperty("jndiName"));
			log.debug("Patientennummer :".concat(String.valueOf(String.valueOf(result))));
			String text = null;
			if (result == -2)
				text =
					String.valueOf(langResource.getObject("FehlerDerArztIstNichtVorhanden"))
						+ String.valueOf(patient.getKonkordatsNr());
			else
				text =
					(String) langResource.getObject("PatientendatenWurdenErfolgreichUebermittelt");
			JOptionPane.showMessageDialog(null, text, (String) langResource.getObject("Resultat"),
				1);
			...
			log.error(e.toString(), e);
			JOptionPane.showMessageDialog(null, e.toString(), (String) langResource
				.getObject("Fehler"), 0);
			statusDialog.dispose();
			System.exit(0);
		} catch (Throwable t) {
			log.error(t.toString(), t);
			JOptionPane.showMessageDialog(null, t.toString(), (String) langResource
				.getObject("Fehler"), 0);
			statusDialog.dispose();
			System.exit(0);
		}
	...
	public static void main(String args[]) throws Exception{
		if (args.length > 0) {
			...
			patientenErfassungProp.store(new FileOutputStream("patientenerfassung.properties"),
				null);
		}
	...
	public String convertGebDate(String gebDat){
		if (gebDat.equals(""))
			...
			return String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String
				.valueOf(gebDat.substring(6))))).append(".").append(gebDat.substring(4, 6)).append(
				".").append(gebDat.substring(0, 4))));
	}
