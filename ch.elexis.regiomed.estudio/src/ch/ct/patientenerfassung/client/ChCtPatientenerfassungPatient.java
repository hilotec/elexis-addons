...
public class ChCtPatientenerfassungPatient implements Serializable {
	...
	public synchronized boolean equals(Object obj){
		...
		if (__equalsCalc != null) {
			...
			__equalsCalc = obj;
			boolean _equals =
				(land == null && other.getLand() == null || land != null
					&& land.equals(other.getLand()))
					&& patientnr == other.getPatientnr()
					&& (sprache == null && other.getSprache() == null || sprache != null
						&& sprache.equals(other.getSprache()))
					&& (unfallvers == null && other.getUnfallvers() == null || unfallvers != null
						&& unfallvers.equals(other.getUnfallvers()))
					&& (plz == null && other.getPlz() == null || plz != null
						&& plz.equals(other.getPlz()))
					&& (strassenr == null && other.getStrassenr() == null || strassenr != null
						&& strassenr.equals(other.getStrassenr()))
					&& (konkordatsNr == null && other.getKonkordatsNr() == null || konkordatsNr != null
						&& konkordatsNr.equals(other.getKonkordatsNr()))
					&& (telefax == null && other.getTelefax() == null || telefax != null
						&& telefax.equals(other.getTelefax()))
					&& anrede == other.getAnrede()
					&& (UVNummer == null && other.getUVNummer() == null || UVNummer != null
						&& UVNummer.equals(other.getUVNummer()))
					&& (KVNummer == null && other.getKVNummer() == null || KVNummer != null
						&& KVNummer.equals(other.getKVNummer()))
					&& (titelfirmaheim == null && other.getTitelfirmaheim() == null || titelfirmaheim != null
						&& titelfirmaheim.equals(other.getTitelfirmaheim()))
					&& (email == null && other.getEmail() == null || email != null
						&& email.equals(other.getEmail()))
					&& (gebDat == null && other.getGebDat() == null || gebDat != null
						&& gebDat.equals(other.getGebDat()))
					&& (ort == null && other.getOrt() == null || ort != null
						&& ort.equals(other.getOrt()))
					&& (arztpatientennr == null && other.getArztpatientennr() == null || arztpatientennr != null
						&& arztpatientennr.equals(other.getArztpatientennr()))
					&& (vorname == null && other.getVorname() == null || vorname != null
						&& vorname.equals(other.getVorname()))
					&& geschlecht == other.getGeschlecht()
					&& (telefonGeschaeft == null && other.getTelefonGeschaeft() == null || telefonGeschaeft != null
						&& telefonGeschaeft.equals(other.getTelefonGeschaeft()))
					&& (krankenvers == null && other.getKrankenvers() == null || krankenvers != null
						&& krankenvers.equals(other.getKrankenvers()))
					&& (telefonPrivat == null && other.getTelefonPrivat() == null || telefonPrivat != null
						&& telefonPrivat.equals(other.getTelefonPrivat()))
					&& (kanton == null && other.getKanton() == null || kanton != null
						&& kanton.equals(other.getKanton()))
					&& artznr == other.getArtznr()
	...
	static {
		typeDesc =
			new TypeDesc(ch.ct.patientenerfassung.client.ChCtPatientenerfassungPatient.class);
